...
<div class="container">
 ...
 <div class="panel-body">
                            <div>
                                <div class="col-lg-12">
                                    <form id="form" action="/surat1/update/{{$surat1->id}}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        <div class="form-group">
                                            <label>Tanggal Surat</label>
                                            <input type="date" name="tanggal_surat" class="form-control" value="{{$surat1->tanggal_surat}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="nomor_surat" class="form-control" value="{{$surat1->nomor_surat}}">
                                        ...
                                        <div class="form-group">
                                            <label>Nomor</label>
                                            <input name="nomor" class="form-control" value="{{$surat1->nomor}}">
                                            @if ($errors->has('nomor'))
                                            <span class="help-block">
                                        ...
                                        <div class="form-group">
                                            <label>Tanggal</label>
                                            <input type="date" name="tanggal" class="form-control" value="{{$surat1->tanggal}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="nomor_keputusan" class="form-control" value="{{$surat1->nomor_keputusan}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tanggal_keputusan" class="form-control" value="{{$surat1->tanggal_keputusan}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tanggal_pelantikan" class="form-control" value="{{$surat1->tanggal_pelantikan}}">
