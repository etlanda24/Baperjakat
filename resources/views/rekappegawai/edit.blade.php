                                    ...
                                    {{ csrf_field() }}
                                        ...
                                        <div class="form-group" name="jenis_kelamin" id="jenis_kelamin">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input name="tanggal_lahir" class="form-control" value="{{$pegawai->tanggal_lahir}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="tmt_jabatan" class="form-control" value="{{$pegawai->tmt_jabatan}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="tgl_pertek" class="form-control" value="{{$pegawai->tgl_pertek}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="tanggal_sk" class="form-control" value="{{$pegawai->tanggal_sk}}">
