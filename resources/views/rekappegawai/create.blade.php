                                    ...
                                    {{ csrf_field() }}
                                        ...
                                        <div class="col-lg-2" name="jenis_kelamin" id="jenis_kelamin">
                                         ...
                                         <div class="col-lg-2"">
                                            ...
                                            <div class="col-lg-10">
                                            <input name="tanggal_lahir" class="form-control" placeholder="Masukkan Tanggal Lahir">
                                        ...
                                        <div class="col-lg-2"">
                                            ...
                                            <div class="col-lg-10">
                                            <input name="tgl_pertek" class="form-control" placeholder="Masukkan Tanggal Pertek">
