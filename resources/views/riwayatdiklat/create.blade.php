...
<div class="container">
 ...
 <div class="panel-body">
                            <div>
                                <div class="col-lg-12">
                                    <form id="form" action="{{ url('/riwayatdiklat/store') }}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            @foreach ($refjenisdiklat as $diklat)
                                            <option value="{{$diklat->nama_diklat}}">{{$diklat->nama_diklat}}</option>
                                            @endforeach    
                                            </select>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" name="tempat_diklat" class="form-control" placeholder="Masukkan Tempat Diklat">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input name="penyelenggara_diklat" type="text" class="form-control" placeholder="Masukkan Penyelenggara Diklat">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="angkatan" class="form-control" placeholder="Masukkan Angkatan">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input name="jumlah_jam" type="text" class="form-control" placeholder="Masukkan Jumlah Jam">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="nomor_sttp" class="form-control" placeholder="Masukkan Nomor STTP">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="date" name="tanggal_sttp" class="form-control" placeholder="Masukkan Tanggal STTP">
                                         ...
                                         <div class="form-group">
                                            <label>Periode</label>
                                            <input name="periode" class="form-control" placeholder="Masukkan Periode">
