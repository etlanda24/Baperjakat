...
<div class="container">
 ...
 <div class="panel-body">
                            <div>
                                <div class="col-lg-12">
                                    <form id="form" action="{{ url('/riwayatpendidikan/store') }}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        <div class="form-group">
                                            <label>Nama Pegawai</label>
                                            <select name="id_pegawai" class="form-control">
                                                @foreach ($pegawai as $value)
                                                <option value="{{$value->id}}">{{$value->nama}} - {{$value->nip_pegawai}}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="fakultas" class="form-control" placeholder="Masukkan Nama Fakultas">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="id_jurusan">
                                                @foreach ($refpendidikan as $ref)
                                                    <option value="{{$ref->id}}">{{$ref->jurusan}} - {{$ref->lembaga_pendidikan}} </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="kota" class="form-control" placeholder="Masukkan Nama Kabupaten/Kota">
                                            @if ($errors->has('kota'))
                                            <span class="help-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="rektor" class="form-control" placeholder="Masukkan Nama Kepsek/Rektor">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="no_ijazah" class="form-control" placeholder="Masukkan Nomor Ijazah">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="tgl_ijazah" class="form-control" placeholder="Masukkan Tanggal Ijazah">
