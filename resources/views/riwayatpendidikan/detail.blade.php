...
<div class="container">
 ...
 <div class="panel-body">
                            <div>
                                <div class="col-lg-12">
                                    <form id="form" action="/riwayatpendidikan" m>
                                    {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="tingkat_pendidikan" class="form-control" disabled>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="fakultas" class="form-control" value="{{$riwayatpendidikan->fakultas}}" disabled>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="jurusan" class="form-control" value="{{$riwayatpendidikan->jurusan}}" disabled>
                                        ...
                                        <div class="form-group">
                                            <label>Alamat</label>
                                           <textarea name="alamat" class="form-control" disabled>{{$riwayatpendidikan->alamat}}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="kota" class="form-control" value="{{$riwayatpendidikan->kota}}" disabled>
                                            @if ($errors->has('kota'))
                                            <span class="help-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="rektor" class="form-control" value="{{$riwayatpendidikan->rektor}}" disabled>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="no_ijazah" class="form-control" value="{{$riwayatpendidikan->no_ijazah}}" disabled>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="tgl_ijazah" class="form-control" value="{{$riwayatpendidikan->tgl_ijazah}}" disabled>
